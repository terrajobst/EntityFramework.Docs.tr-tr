...
Önizleme 2 içeren gelen önemli bir katkı [Paul Middleton](https://github.com/pmiddleton) yöntemine eşleme veritabanı skaler işlevler sağlayan böylece bunlar LINQ sorgularında kullanılır ve SQL çevrilen yerleştirir.
...
Bu gibi yöntemleri otomatik olarak kaydedilir. Sorgularınızda bir yöntem kaydedildikten sonra herhangi bir yere kullanabilirsiniz:
...
Bellek içi veritabanına karşı çalışırken veya koşul değerlendirme con istemci tarafı ortaya gerektiğinde faydalı olabilen Like() bir bellek içi uygulama ile geldiğini unutmayın.
