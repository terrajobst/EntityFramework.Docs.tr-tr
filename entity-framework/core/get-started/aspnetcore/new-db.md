...
Yapmak `BloggingContext` MVC denetleyicileri için kullanılabilir bir hizmet olarak kaydetme `Startup.cs`.

Hizmetler (gibi `BloggingContext`) ile kaydedilen [bağımlılık ekleme](http://docs.asp.net/en/latest/fundamentals/dependency-injection.html) uygulama başlatma sırasında böylece Oluşturucusu aracılığıyla (örneğin, MVC denetleyicileri) hizmetlerini bileşenleri otomatik olarak sağlanabilir parametreleri ve özellikleri.
...
## <a name="additional-tutorials"></a>Ek öğreticiler

* [EF Core üzerinde .NET Core ile SQLite kullanarak yeni bir veritabanı ile çalışmaya başlama](xref:core/get-started/netcore/new-db-sqlite)
* ASP.NET Core MVC:
  * [ASP.NET Core MVC ile çalışmaya başlama](/aspnet/core/tutorials/first-mvc-app/start-mvc)
  * [Bir ASP.NET MVC web uygulamasında EF Core ile çalışmaya başlama](/aspnet/core/data/ef-mvc/intro)
* [Razor sayfaları](/aspnet/core/razor-pages/index):
  * [ASP.NET Core Razor sayfaları kullanmaya başlama](/aspnet/core/tutorials/razor-pages/razor-pages-start)
  * [ASP.NET Core, Entity Framework Core ile Razor sayfaları](https://docs.microsoft.com/aspnet/core/data/ef-rp/intro)
