...
## <a name="association-element-ssdl"></a><span data-ttu-id="fac4b-114">Association öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-114">Association Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="fac4b-135">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-135">Example</span></span>
...
<span data-ttu-id="fac4b-144">**AssociationSet** öğesi aşağıdaki alt öğelere sahip olabilir (listelenen sırayla):</span><span class="sxs-lookup"><span data-stu-id="fac4b-144">The **AssociationSet** element can have the following child elements (in the order listed):</span></span>
...
## <a name="collectiontype-element-ssdl"></a><span data-ttu-id="fac4b-164">CollectionType öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-164">CollectionType Element (SSDL)</span></span>
...
## <a name="dependent-element-ssdl"></a><span data-ttu-id="fac4b-194">Bağımlı öğe (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-194">Dependent Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="fac4b-213">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-213">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-223">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-223">Applicable Attributes</span></span>
...
### <a name="end-element-as-a-child-of-the-association-element"></a><span data-ttu-id="fac4b-233">Ilişki öğesinin bir alt öğesi olarak end öğesi</span><span class="sxs-lookup"><span data-stu-id="fac4b-233">End Element as a Child of the Association Element</span></span>
...
### <a name="end-element-as-a-child-of-the-associationset-element"></a><span data-ttu-id="fac4b-264">Öğeyi AssociationSet öğesinin bir alt öğesi olarak bitir</span><span class="sxs-lookup"><span data-stu-id="fac4b-264">End Element as a Child of the AssociationSet Element</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-294">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-294">Applicable Attributes</span></span>
...
<span data-ttu-id="fac4b-347">**EntityType** öğesi aşağıdaki alt öğelere sahip olabilir (listelenen sırayla):</span><span class="sxs-lookup"><span data-stu-id="fac4b-347">The **EntityType** element can have the following child elements (in the order listed):</span></span>
...
## <a name="function-element-ssdl"></a><span data-ttu-id="fac4b-366">Function öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-366">Function Element (SSDL)</span></span>
...
## <a name="key-element-ssdl"></a><span data-ttu-id="fac4b-424">Anahtar öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-424">Key Element (SSDL)</span></span>
...
|:---------------|:------------|:----------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-447">**Eylem**</span><span class="sxs-lookup"><span data-stu-id="fac4b-447">**Action**</span></span>     | <span data-ttu-id="fac4b-448">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-448">Yes</span></span>         | <span data-ttu-id="fac4b-449">**Cascade** veya **none**.</span><span class="sxs-lookup"><span data-stu-id="fac4b-449">**Cascade** or **None**.</span></span> <span data-ttu-id="fac4b-450">( **Kısıtlanmış** değer geçerli ancak **none**ile aynı davranışa sahiptir.)</span><span class="sxs-lookup"><span data-stu-id="fac4b-450">(The value **Restricted** is valid but has the same behavior as **None**.)</span></span> |

> [!NOTE]
> <span data-ttu-id="fac4b-451">**OnDelete** öğesine herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği) uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-451">Any number of annotation attributes (custom XML attributes) may be applied to the **OnDelete** element.</span></span> <span data-ttu-id="fac4b-452">Ancak, özel öznitelikler SSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-452">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="fac4b-453">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-453">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-454">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-454">Example</span></span>

<span data-ttu-id="fac4b-455">Aşağıdaki örnek, **FK @ no__t-2CustomerOrders** yabancı anahtar kısıtlamasını tanımlayan bir **ilişkilendirme** öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-455">The following example shows an **Association** element that defines the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="fac4b-456">**OnDelete** öğesi, **Customers** tablosundaki satır silindiğinde, **müşteriler** tablosundaki belirli bir satıra başvuran **Orders** tablosundaki tüm satırların silineceğini gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-456">The **OnDelete** element indicates that all rows in the **Orders** table that reference a particular row in the **Customers** table will be deleted if the row in the **Customers** table is deleted.</span></span>
...
## <a name="parameter-element-ssdl"></a><span data-ttu-id="fac4b-457">Parameter öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-457">Parameter Element (SSDL)</span></span>

<span data-ttu-id="fac4b-458">Depo şeması tanım dili (SSDL) içindeki **Parameter** öğesi, bir işlev öğesinin bir alt öğesidir ve veritabanında saklı yordam için parametreleri belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-458">The **Parameter** element in store schema definition language (SSDL) is a child of the Function element that specifies parameters for a stored procedure in the database.</span></span>

<span data-ttu-id="fac4b-459">**Parameter** öğesi aşağıdaki alt öğelere sahip olabilir (listelenen sırayla):</span><span class="sxs-lookup"><span data-stu-id="fac4b-459">The **Parameter** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="fac4b-460">Belgeler (sıfır veya bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-460">Documentation (zero or one)</span></span>
-   <span data-ttu-id="fac4b-461">Ek açıklama öğeleri (sıfır veya daha fazla)</span><span class="sxs-lookup"><span data-stu-id="fac4b-461">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-462">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-462">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-463">Aşağıdaki tabloda, **parametre** öğesine uygulanabilen öznitelikler açıklanmaktadır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-463">The table below describes the attributes that can be applied to the **Parameter** element.</span></span>

| <span data-ttu-id="fac4b-464">Öznitelik adı</span><span class="sxs-lookup"><span data-stu-id="fac4b-464">Attribute Name</span></span> | <span data-ttu-id="fac4b-465">Gereklidir</span><span class="sxs-lookup"><span data-stu-id="fac4b-465">Is Required</span></span> | <span data-ttu-id="fac4b-466">Value</span><span class="sxs-lookup"><span data-stu-id="fac4b-466">Value</span></span>                                                                                                                                                                                                                           |
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-467">**Name**</span><span class="sxs-lookup"><span data-stu-id="fac4b-467">**Name**</span></span>       | <span data-ttu-id="fac4b-468">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-468">Yes</span></span>         | <span data-ttu-id="fac4b-469">Parametrenin adı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="fac4b-470">**Tür**</span><span class="sxs-lookup"><span data-stu-id="fac4b-470">**Type**</span></span>       | <span data-ttu-id="fac4b-471">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-471">Yes</span></span>         | <span data-ttu-id="fac4b-472">Parametre türü.</span><span class="sxs-lookup"><span data-stu-id="fac4b-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="fac4b-473">**Modundaysa**</span><span class="sxs-lookup"><span data-stu-id="fac4b-473">**Mode**</span></span>       | <span data-ttu-id="fac4b-474">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-474">No</span></span>          | <span data-ttu-id="fac4b-475">Parametresinin bir giriş, çıkış veya giriş/çıkış parametresi olup olmadığına bağlı olarak, **içinde**, **Out**veya **InOut** .</span><span class="sxs-lookup"><span data-stu-id="fac4b-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="fac4b-476">**'In**</span><span class="sxs-lookup"><span data-stu-id="fac4b-476">**MaxLength**</span></span>  | <span data-ttu-id="fac4b-477">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-477">No</span></span>          | <span data-ttu-id="fac4b-478">Parametrenin uzunluk üst sınırı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="fac4b-479">**Duyarlılık**</span><span class="sxs-lookup"><span data-stu-id="fac4b-479">**Precision**</span></span>  | <span data-ttu-id="fac4b-480">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-480">No</span></span>          | <span data-ttu-id="fac4b-481">Parametrenin duyarlığı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="fac4b-482">**Ölçek**</span><span class="sxs-lookup"><span data-stu-id="fac4b-482">**Scale**</span></span>      | <span data-ttu-id="fac4b-483">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-483">No</span></span>          | <span data-ttu-id="fac4b-484">Parametresinin ölçeği.</span><span class="sxs-lookup"><span data-stu-id="fac4b-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="fac4b-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="fac4b-485">**SRID**</span></span>       | <span data-ttu-id="fac4b-486">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-486">No</span></span>          | <span data-ttu-id="fac4b-487">Uzamsal sistem başvuru tanımlayıcısı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="fac4b-488">Yalnızca uzamsal türlerin parametreleri için geçerlidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="fac4b-489">Daha fazla bilgi için bkz. [srid](https://en.wikipedia.org/wiki/SRID) ve [srid (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="fac4b-489">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="fac4b-490">**Parametre** öğesine herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği) uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="fac4b-491">Ancak, özel öznitelikler SSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="fac4b-492">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-493">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-493">Example</span></span>

<span data-ttu-id="fac4b-494">Aşağıdaki örnek, giriş parametrelerini belirten iki **parametre** öğesi olan bir **Function** öğesini gösterir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="fac4b-495">Principal öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="fac4b-496">Depo şeması tanım dili (SSDL) içindeki **Principal** öğesi, bir yabancı anahtar kısıtlamasının (başvuru kısıtlaması olarak da bilinir) ana bitimi tanımlayan ReferentialConstraint öğesinin bir alt öğesidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="fac4b-497">**Principal** öğesi, başka bir sütun (veya sütun) tarafından başvurulan bir tablodaki birincil anahtar sütununu (veya sütunları) belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="fac4b-498">**Propertyref** öğeleri hangi sütunlara başvurulduğunu belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="fac4b-499">Dependent öğesi, **Principal** öğesinde belirtilen birincil anahtar sütunlarına başvuruda bulunan sütunları belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="fac4b-500">**Principal** öğesi aşağıdaki alt öğelere sahip olabilir (listelenen sırayla):</span><span class="sxs-lookup"><span data-stu-id="fac4b-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="fac4b-501">PropertyRef (bir veya daha fazla)</span><span class="sxs-lookup"><span data-stu-id="fac4b-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="fac4b-502">Ek açıklama öğeleri (sıfır veya daha fazla)</span><span class="sxs-lookup"><span data-stu-id="fac4b-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-503">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-503">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-504">Aşağıdaki tabloda, **Principal** öğesine uygulanabilen öznitelikler açıklanmaktadır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="fac4b-505">Öznitelik adı</span><span class="sxs-lookup"><span data-stu-id="fac4b-505">Attribute Name</span></span> | <span data-ttu-id="fac4b-506">Gereklidir</span><span class="sxs-lookup"><span data-stu-id="fac4b-506">Is Required</span></span> | <span data-ttu-id="fac4b-507">Value</span><span class="sxs-lookup"><span data-stu-id="fac4b-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-508">**Rol**</span><span class="sxs-lookup"><span data-stu-id="fac4b-508">**Role**</span></span>       | <span data-ttu-id="fac4b-509">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-509">Yes</span></span>         | <span data-ttu-id="fac4b-510">Karşılık gelen End öğesinin **rol** özniteliğiyle aynı değer (kullanılıyorsa); Aksi takdirde, başvurulan sütununu içeren tablonun adı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="fac4b-511">Herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği), **Principal** öğesine uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="fac4b-512">Ancak, özel öznitelikler CSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="fac4b-513">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-514">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-514">Example</span></span>

<span data-ttu-id="fac4b-515">Aşağıdaki örnek, **FK @ no__t-2CustomerOrders** yabancı anahtar kısıtlamasına katılan sütunları belirtmek Için **ReferentialConstraint** öğesi kullanan bir ilişkilendirme öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="fac4b-516">**Principal** öğesi, kısıtlamanın asıl sonu olarak **Müşteri** tablosunun **CustomerID** sütununu belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="fac4b-517">Property öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-517">Property Element (SSDL)</span></span>

<span data-ttu-id="fac4b-518">Depo şeması tanım dili (SSDL) içindeki **özellik** öğesi, temel alınan veritabanındaki bir tablodaki sütunu temsil eder.</span><span class="sxs-lookup"><span data-stu-id="fac4b-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="fac4b-519">**Özellik** öğeleri, bir tablodaki satırları temsil eden EntityType öğelerinin alt öğeleridir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="fac4b-520">Bir **EntityType** öğesinde tanımlanan her **özellik** öğesi bir sütunu temsil eder.</span><span class="sxs-lookup"><span data-stu-id="fac4b-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="fac4b-521">Bir **özellik** öğesinin herhangi bir alt öğesi olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-522">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-522">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-523">Aşağıdaki tabloda, **özellik** öğesine uygulanabilen öznitelikler açıklanmaktadır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="fac4b-524">Öznitelik adı</span><span class="sxs-lookup"><span data-stu-id="fac4b-524">Attribute Name</span></span>            | <span data-ttu-id="fac4b-525">Gereklidir</span><span class="sxs-lookup"><span data-stu-id="fac4b-525">Is Required</span></span> | <span data-ttu-id="fac4b-526">Value</span><span class="sxs-lookup"><span data-stu-id="fac4b-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-527">**Name**</span><span class="sxs-lookup"><span data-stu-id="fac4b-527">**Name**</span></span>                  | <span data-ttu-id="fac4b-528">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-528">Yes</span></span>         | <span data-ttu-id="fac4b-529">Karşılık gelen sütunun adı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="fac4b-530">**Tür**</span><span class="sxs-lookup"><span data-stu-id="fac4b-530">**Type**</span></span>                  | <span data-ttu-id="fac4b-531">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-531">Yes</span></span>         | <span data-ttu-id="fac4b-532">Karşılık gelen sütunun türü.</span><span class="sxs-lookup"><span data-stu-id="fac4b-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="fac4b-533">**Yapılamaz**</span><span class="sxs-lookup"><span data-stu-id="fac4b-533">**Nullable**</span></span>              | <span data-ttu-id="fac4b-534">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-534">No</span></span>          | <span data-ttu-id="fac4b-535">**True** (varsayılan değer) veya false değeri, karşılık gelen sütunun null değere sahip olup olmadığına bağlı olarak **yanlış** .</span><span class="sxs-lookup"><span data-stu-id="fac4b-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="fac4b-536">**Değerinin**</span><span class="sxs-lookup"><span data-stu-id="fac4b-536">**DefaultValue**</span></span>          | <span data-ttu-id="fac4b-537">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-537">No</span></span>          | <span data-ttu-id="fac4b-538">Karşılık gelen sütunun varsayılan değeri.</span><span class="sxs-lookup"><span data-stu-id="fac4b-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="fac4b-539">**'In**</span><span class="sxs-lookup"><span data-stu-id="fac4b-539">**MaxLength**</span></span>             | <span data-ttu-id="fac4b-540">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-540">No</span></span>          | <span data-ttu-id="fac4b-541">Karşılık gelen sütunun uzunluk üst sınırı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="fac4b-542">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="fac4b-542">**FixedLength**</span></span>           | <span data-ttu-id="fac4b-543">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-543">No</span></span>          | <span data-ttu-id="fac4b-544">Karşılık gelen sütun değerinin sabit uzunluklu bir dize olarak depolanıp saklanmayacağı seçeneğe bağlı olarak **doğru** veya **yanlış** .</span><span class="sxs-lookup"><span data-stu-id="fac4b-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="fac4b-545">**Duyarlılık**</span><span class="sxs-lookup"><span data-stu-id="fac4b-545">**Precision**</span></span>             | <span data-ttu-id="fac4b-546">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-546">No</span></span>          | <span data-ttu-id="fac4b-547">Karşılık gelen sütunun duyarlığı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="fac4b-548">**Ölçek**</span><span class="sxs-lookup"><span data-stu-id="fac4b-548">**Scale**</span></span>                 | <span data-ttu-id="fac4b-549">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-549">No</span></span>          | <span data-ttu-id="fac4b-550">Karşılık gelen sütunun ölçeği.</span><span class="sxs-lookup"><span data-stu-id="fac4b-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="fac4b-551">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="fac4b-551">**Unicode**</span></span>               | <span data-ttu-id="fac4b-552">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-552">No</span></span>          | <span data-ttu-id="fac4b-553">Karşılık gelen sütun değerinin bir Unicode dize olarak saklanıp saklanmayacağı **doğru** veya **yanlış** .</span><span class="sxs-lookup"><span data-stu-id="fac4b-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="fac4b-554">**Mediğinden**</span><span class="sxs-lookup"><span data-stu-id="fac4b-554">**Collation**</span></span>             | <span data-ttu-id="fac4b-555">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-555">No</span></span>          | <span data-ttu-id="fac4b-556">Veri kaynağında kullanılacak harmanlama sırasını belirten bir dize.</span><span class="sxs-lookup"><span data-stu-id="fac4b-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="fac4b-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="fac4b-557">**SRID**</span></span>                  | <span data-ttu-id="fac4b-558">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-558">No</span></span>          | <span data-ttu-id="fac4b-559">Uzamsal sistem başvuru tanımlayıcısı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="fac4b-560">Yalnızca uzamsal türlerin özellikleri için geçerlidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="fac4b-561">Daha fazla bilgi için bkz. [srid](https://en.wikipedia.org/wiki/SRID) ve [srid (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="fac4b-561">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="fac4b-562">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="fac4b-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="fac4b-563">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-563">No</span></span>          | <span data-ttu-id="fac4b-564">**Hiçbiri**, **kimlik** (karşılık gelen sütun değeri veritabanında oluşturulan bir kimlik ise) veya **hesaplanmışsa** (karşılık gelen sütun değeri veritabanında hesaplanmışsa).</span><span class="sxs-lookup"><span data-stu-id="fac4b-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="fac4b-565">RowType özellikleri için geçerli değil.</span><span class="sxs-lookup"><span data-stu-id="fac4b-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="fac4b-566">**Özellik** öğesine herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği) uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="fac4b-567">Ancak, özel öznitelikler SSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="fac4b-568">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-569">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-569">Example</span></span>

<span data-ttu-id="fac4b-570">Aşağıdaki örnek, iki alt **özellik** öğesi olan bir **EntityType** öğesi gösterir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="fac4b-571">PropertyRef öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="fac4b-572">Depo şeması tanım dili (SSDL) içindeki **Propertyref** öğesi, özelliğin aşağıdaki rollerden birini gerçekleştireceğini göstermek Için bir EntityType öğesinde tanımlanan bir özelliğe başvurur:</span><span class="sxs-lookup"><span data-stu-id="fac4b-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="fac4b-573">**EntityType** 'ın temsil ettiği tablonun birincil anahtarının bir parçası olun.</span><span class="sxs-lookup"><span data-stu-id="fac4b-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="fac4b-574">Bir veya daha fazla **Propertyref** öğesi, birincil anahtar tanımlamak için kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="fac4b-575">Daha fazla bilgi için bkz. Key öğesi.</span><span class="sxs-lookup"><span data-stu-id="fac4b-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="fac4b-576">Bir başvuru kısıtlamasının bağımlı veya birincil sonu olun.</span><span class="sxs-lookup"><span data-stu-id="fac4b-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="fac4b-577">Daha fazla bilgi için bkz. ReferentialConstraint öğesi.</span><span class="sxs-lookup"><span data-stu-id="fac4b-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="fac4b-578">**Propertyref** öğesi yalnızca aşağıdaki alt öğelere sahip olabilir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="fac4b-579">Belgeler (sıfır veya bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="fac4b-580">Ek açıklama öğeleri</span><span class="sxs-lookup"><span data-stu-id="fac4b-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-581">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-581">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-582">Aşağıdaki tabloda, **Propertyref** öğesine uygulanabilen öznitelikler açıklanmaktadır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="fac4b-583">Öznitelik adı</span><span class="sxs-lookup"><span data-stu-id="fac4b-583">Attribute Name</span></span> | <span data-ttu-id="fac4b-584">Gereklidir</span><span class="sxs-lookup"><span data-stu-id="fac4b-584">Is Required</span></span> | <span data-ttu-id="fac4b-585">Value</span><span class="sxs-lookup"><span data-stu-id="fac4b-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="fac4b-586">**Name**</span><span class="sxs-lookup"><span data-stu-id="fac4b-586">**Name**</span></span>       | <span data-ttu-id="fac4b-587">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-587">Yes</span></span>         | <span data-ttu-id="fac4b-588">Başvurulan özelliğin adı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="fac4b-589">**Propertyref** öğesine herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği) uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="fac4b-590">Ancak, özel öznitelikler CSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="fac4b-591">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-592">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-592">Example</span></span>

<span data-ttu-id="fac4b-593">Aşağıdaki örnek, bir **EntityType** öğesinde tanımlanan bir özelliğe başvurarak birincil anahtar tanımlamak için kullanılan bir **propertyref** öğesini gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="fac4b-594">ReferentialConstraint öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="fac4b-595">Depo şeması tanım dili (SSDL) içindeki **ReferentialConstraint** öğesi, temel veritabanında bir yabancı anahtar kısıtlamasını (başvurusal bütünlük kısıtlaması olarak da bilinir) temsil eder.</span><span class="sxs-lookup"><span data-stu-id="fac4b-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="fac4b-596">Kısıtlamanın asıl ve bağımlı uçları, sırasıyla asıl ve bağımlı alt öğeler tarafından belirtilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="fac4b-597">Principal ve Dependent erimine katılan sütunlara PropertyRef öğeleriyle başvurulur.</span><span class="sxs-lookup"><span data-stu-id="fac4b-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="fac4b-598">**ReferentialConstraint** öğesi Association öğesinin isteğe bağlı bir alt öğesidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="fac4b-599">**İlişki** öğesinde belirtilen yabancı anahtar kısıtlamasını eşlemek Için bir **ReferentialConstraint** öğesi kullanılmazsa, bunu yapmak için bir associationsetmapping öğesi kullanılmalıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="fac4b-600">**ReferentialConstraint** öğesi aşağıdaki alt öğelere sahip olabilir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="fac4b-601">Belgeler (sıfır veya bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="fac4b-602">Asıl (tam olarak bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="fac4b-603">Bağımlı (tam olarak bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="fac4b-604">Ek açıklama öğeleri (sıfır veya daha fazla)</span><span class="sxs-lookup"><span data-stu-id="fac4b-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-605">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-605">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-606">**ReferentialConstraint** öğesine herhangi bir sayıda ek açıklama özniteliği (özel XML özniteliği) uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="fac4b-607">Ancak, özel öznitelikler SSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="fac4b-608">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-609">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-609">Example</span></span>

<span data-ttu-id="fac4b-610">Aşağıdaki örnek, **FK @ no__t-3CustomerOrders** yabancı anahtar kısıtlamasına katılan sütunları belirtmek Için **ReferentialConstraint** öğesi kullanan bir **ilişkilendirme** öğesi gösterir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="fac4b-611">ReturnType öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="fac4b-612">Depo şeması tanım dili (SSDL) içindeki **ReturnType** öğesi, bir **işlev** öğesinde tanımlanan bir işlev için dönüş türünü belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="fac4b-613">Bir işlev dönüş türü, bir **ReturnType** özniteliğiyle de belirtilebilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="fac4b-614">İşlevin dönüş türü, **tür** özniteliği veya **ReturnType** öğesiyle belirtilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="fac4b-615">**ReturnType** öğesi aşağıdaki alt öğelere sahip olabilir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="fac4b-616">CollectionType (bir)</span><span class="sxs-lookup"><span data-stu-id="fac4b-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="fac4b-617">Herhangi bir sayıda ek açıklama özniteliği (özel XML öznitelikleri) **ReturnType** öğesine uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="fac4b-618">Ancak, özel öznitelikler SSDL için ayrılan herhangi bir XML ad alanına ait olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="fac4b-619">İki özel öznitelik için tam nitelikli adlar aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-620">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-620">Example</span></span>

<span data-ttu-id="fac4b-621">Aşağıdaki örnek, bir satır koleksiyonu döndüren bir **işlevi** kullanır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="fac4b-622">RowType öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="fac4b-623">Depo şeması tanım dili (SSDL) içindeki **RowType** öğesi, depoda tanımlanan bir işlev için dönüş türü olarak adlandırılmamış bir yapı tanımlar.</span><span class="sxs-lookup"><span data-stu-id="fac4b-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="fac4b-624">**RowType** öğesi, **CollectionType** öğesinin alt öğesidir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="fac4b-625">**RowType** öğesi aşağıdaki alt öğelere sahip olabilir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="fac4b-626">Özellik (bir veya daha fazla)</span><span class="sxs-lookup"><span data-stu-id="fac4b-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="fac4b-627">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-627">Example</span></span>

<span data-ttu-id="fac4b-628">Aşağıdaki örnek, işlevin satır koleksiyonunu ( **RowType** öğesinde belirtilen şekilde) döndürdüğünü belirtmek Için bir **CollectionType** öğesi kullanan bir saklama işlevi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="fac4b-629">Schema öğesi (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="fac4b-630">Depo şeması tanım dili (SSDL) içindeki **şema** öğesi, bir depolama modeli tanımının kök öğesidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="fac4b-631">Bir depolama modeli oluşturan nesneler, işlevler ve kapsayıcılar için tanımlar içerir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="fac4b-632">**Şema** öğesi aşağıdaki alt öğeleri sıfır veya daha fazla içerebilir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="fac4b-633">Kaldırma</span><span class="sxs-lookup"><span data-stu-id="fac4b-633">Association</span></span>
-   <span data-ttu-id="fac4b-634">entityType</span><span class="sxs-lookup"><span data-stu-id="fac4b-634">EntityType</span></span>
-   <span data-ttu-id="fac4b-635">'Indaki</span><span class="sxs-lookup"><span data-stu-id="fac4b-635">EntityContainer</span></span>
-   <span data-ttu-id="fac4b-636">İşlev</span><span class="sxs-lookup"><span data-stu-id="fac4b-636">Function</span></span>

<span data-ttu-id="fac4b-637">**Şema** öğesi, bir depolama modelindeki varlık türü ve ilişkilendirme nesneleri için ad alanını tanımlamak üzere **Namespace** özniteliğini kullanır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="fac4b-638">Bir ad alanı içinde, iki nesne aynı ada sahip olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="fac4b-639">Depolama modeli ad alanı, **şema** öğesinin XML ad alanından farklıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="fac4b-640">Bir depolama modeli ad alanı ( **ad alanı** özniteliğiyle tanımlandığı gibi) varlık türleri ve ilişkilendirme türleri için bir mantıksal kapsayıcıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="fac4b-641">Bir **şema** öğesinin XML ad alanı ( **xmlns** özniteliğiyle gösterilir), alt öğeler ve **şema** öğesinin öznitelikleri için varsayılan ad alanıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="fac4b-642">@No__t-0 (YYYY ve MM, sırasıyla bir yılı ve ayı temsil eder) biçiminde olan XML ad alanları SSDL için ayrılmıştır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-642">XML namespaces of the form https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="fac4b-643">Özel öğeler ve öznitelikler bu forma sahip ad alanlarında olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="fac4b-644">Uygulanabilir öznitelikler</span><span class="sxs-lookup"><span data-stu-id="fac4b-644">Applicable Attributes</span></span>

<span data-ttu-id="fac4b-645">Aşağıdaki tabloda, özniteliklerin **şema** öğesine uygulanabileceğini açıklanmaktadır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="fac4b-646">Öznitelik adı</span><span class="sxs-lookup"><span data-stu-id="fac4b-646">Attribute Name</span></span>            | <span data-ttu-id="fac4b-647">Gereklidir</span><span class="sxs-lookup"><span data-stu-id="fac4b-647">Is Required</span></span> | <span data-ttu-id="fac4b-648">Value</span><span class="sxs-lookup"><span data-stu-id="fac4b-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-649">**Namespace**</span><span class="sxs-lookup"><span data-stu-id="fac4b-649">**Namespace**</span></span>             | <span data-ttu-id="fac4b-650">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-650">Yes</span></span>         | <span data-ttu-id="fac4b-651">Depolama modelinin ad alanı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-651">The namespace of the storage model.</span></span> <span data-ttu-id="fac4b-652">**Ad alanı** özniteliğinin değeri, bir türün tam nitelikli adını biçimlendirmek için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="fac4b-653">Örneğin, *Müşteri* adlı bir **EntityType** , ExampleModel. Store ad alanında ise, **EntityType** 'ın tam adı örnek model. Store. Customer olur.</span><span class="sxs-lookup"><span data-stu-id="fac4b-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="fac4b-654">Şu dizeler **ad alanı** özniteliği için değer olarak kullanılamaz: **Sistem**, **geçici**veya **EDM**.</span><span class="sxs-lookup"><span data-stu-id="fac4b-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="fac4b-655">**Ad alanı** özniteliği DEĞERI, csdl şeması öğesindeki **Namespace** özniteliğinin değeri ile aynı olamaz.</span><span class="sxs-lookup"><span data-stu-id="fac4b-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="fac4b-656">**Diğer ad**</span><span class="sxs-lookup"><span data-stu-id="fac4b-656">**Alias**</span></span>                 | <span data-ttu-id="fac4b-657">Hayır</span><span class="sxs-lookup"><span data-stu-id="fac4b-657">No</span></span>          | <span data-ttu-id="fac4b-658">Ad alanı adı yerine kullanılan tanımlayıcı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="fac4b-659">Örneğin, *Müşteri* adlı bir **EntityType** , ExampleModel ' de yer alıyorsa. mağaza ad alanı ve **diğer ad** özniteliğinin değeri *Storagemodel*ise, storagemodel. Customer ' i tam adı **olarak kullanabilirsiniz EntityType.**</span><span class="sxs-lookup"><span data-stu-id="fac4b-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="fac4b-660">**Sağlayıcı**</span><span class="sxs-lookup"><span data-stu-id="fac4b-660">**Provider**</span></span>              | <span data-ttu-id="fac4b-661">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-661">Yes</span></span>         | <span data-ttu-id="fac4b-662">Veri sağlayıcısı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="fac4b-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="fac4b-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="fac4b-664">Evet</span><span class="sxs-lookup"><span data-stu-id="fac4b-664">Yes</span></span>         | <span data-ttu-id="fac4b-665">Sağlayıcıya döndürülecek sağlayıcı bildirimini gösteren bir belirteç.</span><span class="sxs-lookup"><span data-stu-id="fac4b-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="fac4b-666">Belirteç için biçim tanımlanmadı.</span><span class="sxs-lookup"><span data-stu-id="fac4b-666">No format for the token is defined.</span></span> <span data-ttu-id="fac4b-667">Belirtecin değerleri sağlayıcı tarafından tanımlanır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="fac4b-668">SQL Server sağlayıcısı bildirim belirteçleri hakkında daha fazla bilgi için bkz. SqlClient Entity Framework.</span><span class="sxs-lookup"><span data-stu-id="fac4b-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="fac4b-669">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-669">Example</span></span>

<span data-ttu-id="fac4b-670">Aşağıdaki örnek, bir **EntityContainer** öğesi, iki **EntityType** öğesi ve bir **ilişkilendirme** öğesi içeren bir **şema** öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="fac4b-671">Ek açıklama öznitelikleri</span><span class="sxs-lookup"><span data-stu-id="fac4b-671">Annotation Attributes</span></span>

<span data-ttu-id="fac4b-672">Depo şeması tanım dili (SSDL) içindeki ek açıklama öznitelikleri, depolama modelindeki öğeler hakkında ek meta veriler sağlayan depolama modelinde özel XML öznitelikleridir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="fac4b-673">Geçerli XML yapısına sahip olmanın yanı sıra, ek açıklama öznitelikleri için aşağıdaki kısıtlamalar geçerlidir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="fac4b-674">Ek açıklama öznitelikleri, SSDL için ayrılan XML ad alanı içinde olmamalıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="fac4b-675">İki ek açıklama özniteliğinin tam nitelikli adları aynı olmamalıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="fac4b-676">Verilen bir SSDL öğesine birden çok ek açıklama özniteliği uygulanabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="fac4b-677">Ek açıklama öğelerinde içerilen meta verilere, System. Data. Metadata. Edm ad alanındaki sınıflar kullanılarak çalışma zamanında erişilebilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-678">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-678">Example</span></span>

<span data-ttu-id="fac4b-679">Aşağıdaki örnek, **OrderID** özelliğine uygulanan bir Annotation özniteliği olan bir EntityType öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="fac4b-680">Örnek ayrıca **EntityType** öğesine eklenen bir ek açıklama öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="fac4b-681">Ek açıklama öğeleri (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="fac4b-682">Depo şeması tanım dili (SSDL) içindeki ek açıklama öğeleri depolama modeli hakkında ek meta veriler sağlayan depolama modelinde özel XML öğeleridir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="fac4b-683">Geçerli XML yapısına ek olarak, aşağıdaki kısıtlamalar ek açıklama öğeleri için geçerlidir:</span><span class="sxs-lookup"><span data-stu-id="fac4b-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="fac4b-684">Ek açıklama öğeleri, SSDL için ayrılan XML ad alanı içinde olmamalıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="fac4b-685">İki ek açıklama öğesinin tam nitelikli adları aynı olmamalıdır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="fac4b-686">Ek açıklama öğeleri, belirli bir SSDL öğesinin tüm diğer alt öğelerinden sonra gelmelidir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="fac4b-687">Birden fazla ek açıklama öğesi, verili bir SSDL öğesinin alt öğesi olabilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="fac4b-688">.NET Framework sürüm 4 ' te başlayarak, ek açıklama öğelerinde içerilen meta verilere System. Data. Metadata. Edm ad alanındaki sınıflar kullanılarak çalışma zamanında erişilebilir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="fac4b-689">Örnek</span><span class="sxs-lookup"><span data-stu-id="fac4b-689">Example</span></span>

<span data-ttu-id="fac4b-690">Aşağıdaki örnek, bir Annotation öğesi (**CustomElement**) olan bir EntityType öğesi gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="fac4b-691">Örnek, **OrderID** özelliğine uygulanan bir ek açıklama özniteliği de gösterir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="fac4b-692">Modeller (SSDL)</span><span class="sxs-lookup"><span data-stu-id="fac4b-692">Facets (SSDL)</span></span>

<span data-ttu-id="fac4b-693">Mağaza şeması tanım dili (SSDL) içindeki modeller Özellik öğelerinde belirtilen sütun türlerinde kısıtlamaları temsil eder.</span><span class="sxs-lookup"><span data-stu-id="fac4b-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="fac4b-694">**Özellikler, özellik** öğelerinde XML öznitelikleri olarak uygulanır.</span><span class="sxs-lookup"><span data-stu-id="fac4b-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="fac4b-695">Aşağıdaki tabloda, SSDL içinde desteklenen modeller açıklanmaktadır:</span><span class="sxs-lookup"><span data-stu-id="fac4b-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="fac4b-696">Kısıtlayan</span><span class="sxs-lookup"><span data-stu-id="fac4b-696">Facet</span></span>           | <span data-ttu-id="fac4b-697">Açıklama</span><span class="sxs-lookup"><span data-stu-id="fac4b-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fac4b-698">**Mediğinden**</span><span class="sxs-lookup"><span data-stu-id="fac4b-698">**Collation**</span></span>   | <span data-ttu-id="fac4b-699">Özelliğin değerlerinde karşılaştırma ve sıralama işlemleri gerçekleştirirken kullanılacak harmanlama sırasını (veya sıralama sırasını) belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="fac4b-700">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="fac4b-700">**FixedLength**</span></span> | <span data-ttu-id="fac4b-701">Sütun değerinin uzunluğunun değişebileceğini belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="fac4b-702">**'In**</span><span class="sxs-lookup"><span data-stu-id="fac4b-702">**MaxLength**</span></span>   | <span data-ttu-id="fac4b-703">Sütun değerinin uzunluk üst sınırını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="fac4b-704">**Duyarlılık**</span><span class="sxs-lookup"><span data-stu-id="fac4b-704">**Precision**</span></span>   | <span data-ttu-id="fac4b-705">**Decimal**türü özellikler için, bir özellik değerinin sahip olduğu basamak sayısını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="fac4b-706">**Time**, **DateTime**ve **DateTimeOffset**türündeki özellikler için, sütun değeri saniyelik kesirli kısmının basamak sayısını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="fac4b-707">**Ölçek**</span><span class="sxs-lookup"><span data-stu-id="fac4b-707">**Scale**</span></span>       | <span data-ttu-id="fac4b-708">Sütun değeri için ondalık noktanın sağ tarafındaki basamak sayısını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="fac4b-709">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="fac4b-709">**Unicode**</span></span>     | <span data-ttu-id="fac4b-710">Sütun değerinin Unicode olarak depolandığını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fac4b-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
