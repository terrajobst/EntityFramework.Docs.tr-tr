...
> [!NOTE]
> Include, System. Data. Entity ad alanındaki bir genişletme yöntemidir, bu nedenle bu ad alanını kullandığınızdan emin olun.
...
> [!NOTE]
> Bir varlığın başka bir varlık için gezinti özelliği olduğunda başvuru yöntemi kullanılmalıdır. Diğer taraftan, bir varlık başka varlıkların koleksiyonuna bir gezinti özelliği olduğunda, koleksiyon yöntemi kullanılmalıdır.
...
> [!NOTE]
> İlişki bir lambda ifadesi yerine bir dize olarak belirtilebildiği sürece, bir dize kullanıldığında döndürülen IQueryable genel değildir ve bu nedenle, bu işlem ile herhangi bir faydalı işlem yapılmadan önce atama yöntemi gerekir.
