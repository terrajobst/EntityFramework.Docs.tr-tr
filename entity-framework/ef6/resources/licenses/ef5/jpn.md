...
---
# <a name="entity-framework-5-license-jpn"></a>Entity Framework 5 lisans (JPN)
**マイクロソフト ソフトウェア 追加ライセンス条項**

**MICROSOFT WINDOWS İŞLETİM SİSTEMİ İÇİN ENTITY FRAMEWORK 5.0**

Microsoft Corporation'ın (以下「マイクロソフト」といいます) は、本追加ソフトウェアのライセンスをお客様に供与します。Microsoft Windows işletim sistemi ソフトウェア(以下「本ソフトウェア」といいます) を使用するためのラインセンスを取得している場合は、本追加ソフトウェアを使用できます。本ソフトウェアのライセンスを取得していない場合は、本追加ソフトウェアを使用することはできません。1 お客様は、本ソフトウェアの有効なライセンス取得済みの複製 部ごとに本追加ソフトウェアを使用できます。
